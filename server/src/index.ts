...
import globalImportRoutes from './routes/global-import';
...
import { ensureInitialData } from './storage';

// 首次启动时自动保存初始数据 (Requirements: 2.5.1)
ensureInitialData();
...
app.use('/api/global-import', globalImportRoutes);
